...
show()
savefig("scalar_flux_vartheta_0-05_exp_Euler_nx$(s.NCellsX).png")
...
show()
savefig("scalar_flux_vartheta_0-025_exp_Euler_nx$(s.NCellsX).png")
...
show()
savefig("scalar_flux_vartheta_0-01_exp_Euler_nx$(s.NCellsX).png")
...
show()
savefig("scalar_flux_vartheta_0-05_heun_nx$(s.NCellsX).png")
...
show()
savefig("scalar_flux_vartheta_0-025_heun_nx$(s.NCellsX).png")
...
show()
savefig("scalar_flux_vartheta_0-01_heun_nx$(s.NCellsX).png")
